...
export function injectCreateMovie(
  options?: CreateMovieOptions,
  injector?: Injector
): CreateDataConnectMutationResult<CreateMovieData, CreateMovieVariables, CreateMovieVariables>;

type UpsertUserOptions = DataConnectMutationOptionsUndefinedMutationFn<UpsertUserData, FirebaseError, UpsertUserVariables>;
export function injectUpsertUser(
  options?: UpsertUserOptions,
  injector?: Injector
): CreateDataConnectMutationResult<UpsertUserData, UpsertUserVariables, UpsertUserVariables>;

type AddReviewOptions = DataConnectMutationOptionsUndefinedMutationFn<AddReviewData, FirebaseError, AddReviewVariables>;
export function injectAddReview(
  options?: AddReviewOptions,
  injector?: Injector
): CreateDataConnectMutationResult<AddReviewData, AddReviewVariables, AddReviewVariables>;
...
export function injectDeleteReview(
  options?: DeleteReviewOptions,
  injector?: Injector
): CreateDataConnectMutationResult<DeleteReviewData, DeleteReviewVariables, DeleteReviewVariables>;
...
export function injectListUserReviews(
  options?: ListUserReviewsOptions,
  injector?: Injector
): CreateDataConnectQueryResult<ListUserReviewsData, undefined>;
...
export function injectGetMovieById(
  args: GetMovieByIdArgs,
  options?: GetMovieByIdOptions,
  injector?: Injector
): CreateDataConnectQueryResult<GetMovieByIdData, GetMovieByIdVariables>;
...
export function injectSearchMovie(
  args?: SearchMovieArgs,
  options?: SearchMovieOptions,
  injector?: Injector
): CreateDataConnectQueryResult<SearchMovieData, SearchMovieVariables>;
